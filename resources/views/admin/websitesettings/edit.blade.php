                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea type="text" class="form-control" name="address_ar"
                                                      ...
                                                      rows="3">{{ isset($item) ? getLangValue($item->address, 'ar') : old('address_ar') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea type="text" class="form-control" name="address_en"
                                                      ...
                                                      rows="3">{{ isset($item) ? getLangValue($item->address, 'en') : old('address_en') }}</textarea>
                                        </div>
                                    </div>
                                </div>
