            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{isset($item) ? 'Edit Manufactures' : 'New Manufactures'}}</li>
                    </ul>
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <a href="{{route('manufactures.index')}}" class="btn btn-warning btn-icon float-right"><i
                    ...
                    <div class="card">
                        <div class="body">
                            <form id="form_advanced_validation"
                                  ...
                                  method="POST"
                                  action="{{ isset($item) ? route('manufactures.update',$item->id) : route('manufactures.store') }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <input type="text" class="form-control" name="title_ar"
                                                   ...
                                                   placeholder="Manufacture Title-AR"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <input type="text" class="form-control" name="title_en"
                                                   ...
                                                   placeholder="Manufacture Title-EN"
                                                   minlength="2" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea type="text" class="form-control" name="description_ar"
                                                      placeholder="Manufacture Description-AR"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea type="text" class="form-control" name="description_en"
                                                      placeholder="Manufacture Description-EN"
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <label>Popular</label>
                                        <div class="form-group form-float">
                                            <select name="popular" class="form-control show-tick ms select2"
                                                    data-placeholder="Select">
                                                <option
                                                    value="0" {{ isset($item) && $item->popular == 0 ? "Selected" : "" }}>
                                                    NO
                                                </option>
                                                <option
                                                    value="1" {{ isset($item) && $item->popular == 1 ? "Selected" : "" }}>
                                                    Yes
                                                </option>
                                            </select>
                                        </div>
