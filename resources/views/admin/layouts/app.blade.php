...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="{{asset('admin')}}/images/logo.svg" width="25" alt="Aero"><span
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="{{($segment1 == 'admin' && $segment2 == 'staff') || ($segment1 == 'admin' && $segment2 == 'customers') ? 'active' :'' }}">
                <a href="javascript:void(0);" class="menu-toggle"><i
                        class="zmdi zmdi-apps"></i><span>Users Settings</span></a>
                <ul class="ml-menu">
            ...
            <li class="{{($segment1 == 'admin' && $segment2 == 'cartridges') ? 'active' :'' }}"><a
                    href="{{route('cartridges.index')}}"><i
                        class="zmdi zmdi-home"></i><span>Cartridge</span></a></li>

            <li class="{{($segment1 == 'admin' && $segment2 == 'printers') ? 'active' :'' }}"><a
                    href="{{route('printers.index')}}"><i
                        class="zmdi zmdi-home"></i><span>Printers</span></a></li>

            <li class="{{($segment1 == 'admin' && $segment2 == 'categories') || ($segment1 == 'admin' && $segment2 == 'types') || ($segment1 == 'admin' && $segment2 == 'manufactures') ||($segment1 == 'admin' && $segment2 == 'features') || ($segment1 == 'admin' && $segment2 == 'colors') ? 'active' :'' }}">
                <a href="javascript:void(0);" class="menu-toggle"><i
                        class="zmdi zmdi-apps"></i><span>Cartridge Settings</span></a>
                <ul class="ml-menu">
                    <li class="{{($segment1 == 'admin' && $segment2 == 'categories') ? 'active' :'' }}">
                        <a href="{{route('categories.index')}}">Categories</a>
                    </li>
                    <li class="{{($segment1 == 'admin' && $segment2 == 'types') ? 'active' :'' }}">
                        <a href="{{route('types.index')}}">Types</a>
                    </li>
                    <li class="{{($segment1 == 'admin' && $segment2 == 'manufactures') ? 'active' :'' }}">
                        <a href="{{route('manufactures.index')}}">Manufactures</a>
                    </li>
                    <li class="{{($segment1 == 'admin' && $segment2 == 'features') ? 'active' :'' }}">
                        <a href="{{route('features.index')}}">Features</a>
                    </li>
                    <li class="{{($segment1 == 'admin' && $segment2 == 'colors') ? 'active' :'' }}">
            ...
            <li class="{{($segment1 == 'admin' && $segment2 == 'website-settings') ? 'active' :'' }}"><a
                    href="{{route('website-settings.index')}}"><i
                        class="zmdi zmdi-home"></i><span>Website Settings</span></a></li>

            <li class="{{($segment1 == 'admin' && $segment2 == 'sliders') || ($segment1 == 'admin' && $segment2 == 'services') || ($segment1 == 'admin' && $segment2 == 'teams')? 'active' :'' }}">
                <a href="javascript:void(0);" class="menu-toggle"><i
                        class="zmdi zmdi-apps"></i><span>Home Settings</span></a>
                <ul class="ml-menu">
